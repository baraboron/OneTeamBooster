...
COPY index.html styles.css app.js admin.js ui.js leader.js leader-domain.js home.js home-domain.js home-config.js leaderboard-client.js motivation-templates.js praise-copy.js api-client.js employee-picker.js test-workspace.js /usr/share/nginx/html/
